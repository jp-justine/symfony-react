 ...
 */
final class Version20220331131622 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD birthdate DATE NOT NULL');
    }
